...
local Library do 
    ...
    local Themes = {
        ["Default"] = {
            ["Window Background"] = FromRGB(15, 15, 17),
            ["Inline"] = FromRGB(24, 24, 28),
            ["Text"] = FromRGB(240, 240, 245),
            ["Section Background"] = FromRGB(18, 18, 22),
            ["Element"] = FromRGB(28, 28, 34),
            ["Border"] = FromRGB(40, 40, 45),
            ["Outline"] = FromRGB(10, 10, 12),
            ["Dark Liner"] = FromRGB(35, 35, 40),
            ["Risky"] = FromRGB(220, 50, 50),
            ["Accent"] = FromRGB(200, 200, 205)
        },
    ...
    Components.Keybind = function(Data)
        ...
        local Update = function()
            if not KeybindListItem and Library.KeyList then
                KeybindListItem = Library.KeyList:Add(Keybind.Mode, Data.Name, Keybind.Value)
            end
    ...
    Library.Sections.Input = Library.Sections.Textbox
